...
public class CitizenController {
    ...
    @PutMapping("{id}")
    public ResponseEntity<Citizen> update(@PathVariable Long id, @RequestBody Citizen entity) throws NotFoundException {
        return ResponseEntity.ok(service.update(id, entity));
    }
    @DeleteMapping("{id}")
    public ResponseEntity<Citizen> delete(@PathVariable Long id) throws NotFoundException {
        service.delete(id);
